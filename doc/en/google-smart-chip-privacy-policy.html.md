...
4. **User Control**: You retain full control over your data. The add-on functions essentially in read-only mode. It only edits the Google Sheets™ document if the user chooses to take use the _"Replace URL with its title?"_ Google Smart Chips option.
