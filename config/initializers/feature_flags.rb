...
Rails.application.config.feature_minting_enabled = true # minting includes reconciliation and linking sameAs.
Rails.application.config.feature_refresh_entity_enabled = true
Rails.application.config.feature_delete_entity_enabled = true
