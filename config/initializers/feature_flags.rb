...
Rails.application.config.feature_minting_enabled = false
Rails.application.config.feature_maintenance_mode_enabled = true # set to false for normal operation
