...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rdf-n3>.freeze, ["~> 3.3"])
  ...
  s.add_runtime_dependency(%q<ld-patch>.freeze, ["~> 3.3"])
  s.add_runtime_dependency(%q<shacl>.freeze, ["~> 0.4"])
  s.add_runtime_dependency(%q<shex>.freeze, ["~> 0.8"])
